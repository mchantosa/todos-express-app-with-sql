...
module.exports = class SessionPersistence {
  ...
  // Returns a copy of the todo list with the indicated ID. Returns `undefined` if not found.
...
// numeric.
  ...
  completeAllTodos(todoListId) {
    ...
    todoList.todos.filter(todo => todo.done === false)
  ...
  deleteTodoList(todoListId){
    let index = this._todoLists.indexOf(todoList => todoList.id === todoListId);
